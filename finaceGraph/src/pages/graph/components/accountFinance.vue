...
export default {
  ...
  computed: {
    rebuildData() {
      if (this.type === SIDE_TYPE.ACCOUNT_FINANCE_GROUP_COMPANY) {
    ...
    isShowGroupByCompany() {
      return this.type === SIDE_TYPE.ACCOUNT_FINANCE_GROUP_COMPANY;
    },
    isJoinDetail() {
      return this.type === SIDE_TYPE.ACCOUNT_FINANCE_JOIN_DETAIL;
    },
  },
};
</script>
